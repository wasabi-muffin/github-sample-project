...
fun RepositoryDetails.Element.note(details: RepositoryDetails) = when (this) {
    ...
    RepositoryDetails.Element.PullRequests -> TODO()
    RepositoryDetails.Element.Releases -> details.releases.count().toDoubleDigitString()
    RepositoryDetails.Element.Contributors -> details.contributors.count().toDoubleDigitString()
