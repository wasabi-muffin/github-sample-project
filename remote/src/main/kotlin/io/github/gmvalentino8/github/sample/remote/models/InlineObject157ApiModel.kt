...
/**
 * 
 * @param content The [reaction type](https://docs.github.com/rest/reference/reactions#reaction-types) to add to the team discussion.
 */
@Serializable
data class InlineObject157ApiModel(
    /* The [reaction type](https://docs.github.com/rest/reference/reactions#reaction-types) to add to the team discussion. */
    @SerialName(value = "content")
    val content: InlineObject157ApiModel.Content
) {
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "InlineObject157ApiModel.Content.Serializer",
