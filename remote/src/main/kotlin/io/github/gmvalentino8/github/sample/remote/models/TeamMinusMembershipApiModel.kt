 ...
 */
@Serializable
data class TeamMinusMembershipApiModel(
    @SerialName(value = "url")
    val url: kotlin.String,
    /* The role of the user in the team. */
    @SerialName(value = "role")
    val role: TeamMinusMembershipApiModel.Role = Role.member,
    /* The state of the user's membership in the team. */
    @SerialName(value = "state")
    val state: TeamMinusMembershipApiModel.State
) {
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "TeamMinusMembershipApiModel.Role.Serializer",
    ...
    enum class State(val value: kotlin.String) {
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "TeamMinusMembershipApiModel.State.Serializer",
                    PrimitiveKind.STRING
                )
