...
/**
 * 
 * @param content The [reaction type](https://docs.github.com/rest/reference/reactions#reaction-types) to add to the pull request review comment.
 */
@Serializable
data class InlineObject119ApiModel(
    /* The [reaction type](https://docs.github.com/rest/reference/reactions#reaction-types) to add to the pull request review comment. */
    @SerialName(value = "content")
    val content: InlineObject119ApiModel.Content
) {
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "InlineObject119ApiModel.Content.Serializer",
