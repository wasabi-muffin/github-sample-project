...
/**
 * 
 * @param content The [reaction type](https://docs.github.com/rest/reference/reactions#reaction-types) to add to the commit comment.
 */
@Serializable
data class InlineObject76ApiModel(
    /* The [reaction type](https://docs.github.com/rest/reference/reactions#reaction-types) to add to the commit comment. */
    @SerialName(value = "content")
    val content: InlineObject76ApiModel.Content
) {
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "InlineObject76ApiModel.Content.Serializer",
