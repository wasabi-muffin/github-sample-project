...
import jp.co.yumemi.android.code_check.remote.models.RenamedIssueEventRenameApiModel
 ...
 */
@Serializable
data class RenamedMinusIssueMinusEventApiModel(
    @SerialName(value = "id")
    val id: kotlin.Int,
    ...
    val rename: RenamedIssueEventRenameApiModel
) {
