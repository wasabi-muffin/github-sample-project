...
/**
 * 
 * @param content The [reaction type](https://docs.github.com/rest/reference/reactions#reaction-types) to add to the issue comment.
 */
@Serializable
data class InlineObject101ApiModel(
    /* The [reaction type](https://docs.github.com/rest/reference/reactions#reaction-types) to add to the issue comment. */
    @SerialName(value = "content")
    val content: InlineObject101ApiModel.Content
) {
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "InlineObject101ApiModel.Content.Serializer",
