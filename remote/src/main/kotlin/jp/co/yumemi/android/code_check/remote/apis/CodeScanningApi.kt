...
interface CodeScanningApi {
    ...
    *
    * @return CodeMinusScanningMinusAnalysisMinusDeletionModel
    */
    suspend fun codeScanningDeleteAnalysis(accessToken: String? = null, owner: kotlin.String, repo: kotlin.String, analysisId: kotlin.Int, confirmDelete: kotlin.String? = null): CodeMinusScanningMinusAnalysisMinusDeletionModel
    ...
    *
    * @return CodeMinusScanningMinusAlertModel
    */
    suspend fun codeScanningGetAlert(accessToken: String? = null, owner: kotlin.String, repo: kotlin.String, alertNumber: kotlin.Int): CodeMinusScanningMinusAlertModel
    ...
    *
    * @return CodeMinusScanningMinusSarifsMinusStatusModel
    */
    suspend fun codeScanningGetSarif(accessToken: String? = null, owner: kotlin.String, repo: kotlin.String, sarifId: kotlin.String): CodeMinusScanningMinusSarifsMinusStatusModel
    ...
    *
    * @return kotlin.collections.List<CodeMinusScanningMinusAlertMinusInstanceModel>
    */
    suspend fun codeScanningListAlertInstances(accessToken: String? = null, owner: kotlin.String, repo: kotlin.String, alertNumber: kotlin.Int, page: kotlin.Int? = null, perPage: kotlin.Int? = null, ref: kotlin.String? = null): kotlin.collections.List<CodeMinusScanningMinusAlertMinusInstanceModel>
    ...
    *
    * @return kotlin.collections.List<CodeMinusScanningMinusOrganizationMinusAlertMinusItemsModel>
    */
    suspend fun codeScanningListAlertsForOrg(accessToken: String? = null, org: kotlin.String, before: kotlin.String? = null, after: kotlin.String? = null, page: kotlin.Int? = null, perPage: kotlin.Int? = null, direction: kotlin.String? = null, state: CodeMinusScanningMinusAlertMinusStateModel? = null, sort: kotlin.String? = null): kotlin.collections.List<CodeMinusScanningMinusOrganizationMinusAlertMinusItemsModel>
    ...
    *
    * @return kotlin.collections.List<CodeMinusScanningMinusAlertMinusItemsModel>
    */
    suspend fun codeScanningListAlertsForRepo(accessToken: String? = null, owner: kotlin.String, repo: kotlin.String, toolName: kotlin.String? = null, toolGuid: kotlin.String? = null, page: kotlin.Int? = null, perPage: kotlin.Int? = null, ref: kotlin.String? = null, direction: kotlin.String? = null, sort: kotlin.String? = null, state: CodeMinusScanningMinusAlertMinusStateModel? = null): kotlin.collections.List<CodeMinusScanningMinusAlertMinusItemsModel>
    ...
    *
    * @return kotlin.collections.List<CodeMinusScanningMinusAnalysisModel>
    */
    suspend fun codeScanningListRecentAnalyses(accessToken: String? = null, owner: kotlin.String, repo: kotlin.String, toolName: kotlin.String? = null, toolGuid: kotlin.String? = null, page: kotlin.Int? = null, perPage: kotlin.Int? = null, ref: kotlin.String? = null, sarifId: kotlin.String? = null): kotlin.collections.List<CodeMinusScanningMinusAnalysisModel>
    ...
    * @return CodeMinusScanningMinusAlertModel
    */
    suspend fun codeScanningUpdateAlert(accessToken: String? = null, owner: kotlin.String, repo: kotlin.String, alertNumber: kotlin.Int, request: InlineObject71Model): CodeMinusScanningMinusAlertModel
    ...
    *
    * @param request 
    * @return CodeMinusScanningMinusSarifsMinusReceiptModel
    */
    suspend fun codeScanningUploadSarif(accessToken: String? = null, owner: kotlin.String, repo: kotlin.String, request: InlineObject72Model): CodeMinusScanningMinusSarifsMinusReceiptModel
...
class HttpClientCodeScanningApi(private val httpClientProvider: HttpClientProvider) : CodeScanningApi {
    ...
    override suspend fun codeScanningDeleteAnalysis(accessToken: String?, owner: kotlin.String, repo: kotlin.String, analysisId: kotlin.Int, confirmDelete: kotlin.String?): CodeMinusScanningMinusAnalysisMinusDeletionModel {
        val path = "/repos/{owner}/{repo}/code-scanning/analyses/{analysis_id}".replace("{"+"owner"+"}", "$owner").replace("{"+"repo"+"}", "$repo").replace("{"+"analysis_id"+"}", "$analysisId")
    ...
    override suspend fun codeScanningGetAlert(accessToken: String?, owner: kotlin.String, repo: kotlin.String, alertNumber: kotlin.Int): CodeMinusScanningMinusAlertModel {
        val path = "/repos/{owner}/{repo}/code-scanning/alerts/{alert_number}".replace("{"+"owner"+"}", "$owner").replace("{"+"repo"+"}", "$repo").replace("{"+"alert_number"+"}", "$alertNumber")
    ...
    override suspend fun codeScanningGetSarif(accessToken: String?, owner: kotlin.String, repo: kotlin.String, sarifId: kotlin.String): CodeMinusScanningMinusSarifsMinusStatusModel {
        val path = "/repos/{owner}/{repo}/code-scanning/sarifs/{sarif_id}".replace("{"+"owner"+"}", "$owner").replace("{"+"repo"+"}", "$repo").replace("{"+"sarif_id"+"}", "$sarifId")
    ...
    override suspend fun codeScanningListAlertInstances(accessToken: String?, owner: kotlin.String, repo: kotlin.String, alertNumber: kotlin.Int, page: kotlin.Int?, perPage: kotlin.Int?, ref: kotlin.String?): kotlin.collections.List<CodeMinusScanningMinusAlertMinusInstanceModel> {
        val path = "/repos/{owner}/{repo}/code-scanning/alerts/{alert_number}/instances".replace("{"+"owner"+"}", "$owner").replace("{"+"repo"+"}", "$repo").replace("{"+"alert_number"+"}", "$alertNumber")
    ...
    override suspend fun codeScanningListAlertsForOrg(accessToken: String?, org: kotlin.String, before: kotlin.String?, after: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?, direction: kotlin.String?, state: CodeMinusScanningMinusAlertMinusStateModel?, sort: kotlin.String?): kotlin.collections.List<CodeMinusScanningMinusOrganizationMinusAlertMinusItemsModel> {
    ...
    override suspend fun codeScanningListAlertsForRepo(accessToken: String?, owner: kotlin.String, repo: kotlin.String, toolName: kotlin.String?, toolGuid: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?, ref: kotlin.String?, direction: kotlin.String?, sort: kotlin.String?, state: CodeMinusScanningMinusAlertMinusStateModel?): kotlin.collections.List<CodeMinusScanningMinusAlertMinusItemsModel> {
        val path = "/repos/{owner}/{repo}/code-scanning/alerts".replace("{"+"owner"+"}", "$owner").replace("{"+"repo"+"}", "$repo")
    ...
    override suspend fun codeScanningListRecentAnalyses(accessToken: String?, owner: kotlin.String, repo: kotlin.String, toolName: kotlin.String?, toolGuid: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?, ref: kotlin.String?, sarifId: kotlin.String?): kotlin.collections.List<CodeMinusScanningMinusAnalysisModel> {
        val path = "/repos/{owner}/{repo}/code-scanning/analyses".replace("{"+"owner"+"}", "$owner").replace("{"+"repo"+"}", "$repo")
    ...
    override suspend fun codeScanningUpdateAlert(accessToken: String?, owner: kotlin.String, repo: kotlin.String, alertNumber: kotlin.Int, request: InlineObject71Model): CodeMinusScanningMinusAlertModel {
        val path = "/repos/{owner}/{repo}/code-scanning/alerts/{alert_number}".replace("{"+"owner"+"}", "$owner").replace("{"+"repo"+"}", "$repo").replace("{"+"alert_number"+"}", "$alertNumber")
    ...
    override suspend fun codeScanningUploadSarif(accessToken: String?, owner: kotlin.String, repo: kotlin.String, request: InlineObject72Model): CodeMinusScanningMinusSarifsMinusReceiptModel {
        val path = "/repos/{owner}/{repo}/code-scanning/sarifs".replace("{"+"owner"+"}", "$owner").replace("{"+"repo"+"}", "$repo")
