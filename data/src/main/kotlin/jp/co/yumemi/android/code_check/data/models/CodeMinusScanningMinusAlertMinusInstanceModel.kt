...
import jp.co.yumemi.android.code_check.data.models.CodeMinusScanningMinusAlertMinusClassificationModel
import jp.co.yumemi.android.code_check.data.models.CodeMinusScanningMinusAlertMinusLocationModel
import jp.co.yumemi.android.code_check.data.models.CodeMinusScanningMinusAlertMinusStateModel
import jp.co.yumemi.android.code_check.data.models.CodeScanningAlertInstanceMessageModel
 ...
 */
@Serializable
data class CodeMinusScanningMinusAlertMinusInstanceModel(
    ...
    val state: CodeMinusScanningMinusAlertMinusStateModel? = null,
    @SerialName(value = "commit_sha")
    val commitSha: kotlin.String? = null,
    @SerialName(value = "message")
    val message: CodeScanningAlertInstanceMessageModel? = null,
    @SerialName(value = "location")
    val location: CodeMinusScanningMinusAlertMinusLocationModel? = null,
    ...
    val classifications: kotlin.collections.List<@Contextual CodeMinusScanningMinusAlertMinusClassificationModel>? = null
) {
