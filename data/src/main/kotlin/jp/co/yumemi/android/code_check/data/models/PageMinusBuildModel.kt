...
import jp.co.yumemi.android.code_check.data.models.PageBuildErrorModel
 ...
 */
@Serializable
data class PageMinusBuildModel(
    @SerialName(value = "url")
    val url: kotlin.String,
    @SerialName(value = "status")
    val status: kotlin.String,
    @SerialName(value = "error")
    val error: PageBuildErrorModel,
    @SerialName(value = "pusher")
    val pusher: NullableMinusSimpleMinusUserModel?,
