 ...
 */
@Serializable
data class CommitMinusComparisonModel(
    ...
    val baseCommit: CommitModel,
    @SerialName(value = "merge_base_commit")
    val mergeBaseCommit: CommitModel,
    @SerialName(value = "status")
    val status: CommitMinusComparisonModel.Status,
    ...
    val commits: kotlin.collections.List<CommitModel>,
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "CommitMinusComparisonModel.Status.Serializer",
