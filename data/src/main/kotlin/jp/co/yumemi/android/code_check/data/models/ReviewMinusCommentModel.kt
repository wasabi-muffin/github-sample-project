...
import jp.co.yumemi.android.code_check.data.models.ReviewCommentLinksModel
 ...
 */
@Serializable
data class ReviewMinusCommentModel(
    ...
    val links: ReviewCommentLinksModel,
    ...
    val side: ReviewMinusCommentModel.Side? = Side.rIGHT,
    /* The side of the first line of the range for a multi-line comment. */
    @SerialName(value = "start_side")
    val startSide: ReviewMinusCommentModel.StartSide? = StartSide.rIGHT,
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "ReviewMinusCommentModel.Side.Serializer",
    ...
    enum class StartSide(val value: kotlin.String) {
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "ReviewMinusCommentModel.StartSide.Serializer",
                    PrimitiveKind.STRING
                )
