 ...
 */
@Serializable
data class CodeMinusScanningMinusSarifsMinusStatusModel(
    /* `pending` files have not yet been processed, while `complete` means results from the SARIF have been stored. `failed` files have either not been processed at all, or could only be partially processed. */
    @SerialName(value = "processing_status")
    val processingStatus: CodeMinusScanningMinusSarifsMinusStatusModel.ProcessingStatus? = null,
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "CodeMinusScanningMinusSarifsMinusStatusModel.ProcessingStatus.Serializer",
