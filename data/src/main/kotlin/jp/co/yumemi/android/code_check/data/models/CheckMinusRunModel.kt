...
import jp.co.yumemi.android.code_check.data.models.CheckRunCheckSuiteModel
import jp.co.yumemi.android.code_check.data.models.CheckRunOutputModel
import jp.co.yumemi.android.code_check.data.models.DeploymentMinusSimpleModel
...
data class CheckMinusRunModel(
    ...
    val status: CheckMinusRunModel.Status,
    @SerialName(value = "conclusion")
    val conclusion: CheckMinusRunModel.Conclusion?,
    ...
    val output: CheckRunOutputModel,
    /* The name of the check. */
    @SerialName(value = "name")
    val name: kotlin.String,
    @SerialName(value = "check_suite")
    val checkSuite: CheckRunCheckSuiteModel?,
    ...
    val deployment: DeploymentMinusSimpleModel? = null
) {
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "CheckMinusRunModel.Status.Serializer",
    ...
    enum class Conclusion(val value: kotlin.String) {
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "CheckMinusRunModel.Conclusion.Serializer",
                    PrimitiveKind.STRING
                )
