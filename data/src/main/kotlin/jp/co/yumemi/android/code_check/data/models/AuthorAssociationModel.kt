 ...
 */
@Serializable
enum class AuthorAssociationModel(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: Any?): kotlin.String? = if (data is AuthorAssociationModel) "$data" else null

        /**
         * Returns a valid [AuthorAssociationModel] for [data], null otherwise.
         */
        fun decode(data: Any?): AuthorAssociationModel? = data?.let {
