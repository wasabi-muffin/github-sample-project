 ...
 */
@Serializable
data class ReposOwnerRepoGitTreesTreeModel(
    /* The file referenced in the tree. */
    @SerialName(value = "path")
    val path: kotlin.String? = null,
    /* The file mode; one of `100644` for file (blob), `100755` for executable (blob), `040000` for subdirectory (tree), `160000` for submodule (commit), or `120000` for a blob that specifies the path of a symlink. */
    @SerialName(value = "mode")
    val mode: ReposOwnerRepoGitTreesTreeModel.Mode? = null,
    /* Either `blob`, `tree`, or `commit`. */
    @SerialName(value = "type")
    val type: ReposOwnerRepoGitTreesTreeModel.Type? = null,
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "ReposOwnerRepoGitTreesTreeModel.Mode.Serializer",
    ...
    enum class Type(val value: kotlin.String) {
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "ReposOwnerRepoGitTreesTreeModel.Type.Serializer",
                    PrimitiveKind.STRING
                )
