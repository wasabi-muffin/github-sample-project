...
import jp.co.yumemi.android.code_check.data.models.TeamProjectPermissionsModel
 ...
 */
@Serializable
data class TeamMinusProjectModel(
    ...
    val creator: SimpleMinusUserModel,
    @SerialName(value = "created_at")
    val createdAt: kotlin.String,
    @SerialName(value = "updated_at")
    val updatedAt: kotlin.String,
    @SerialName(value = "permissions")
    val permissions: TeamProjectPermissionsModel,
