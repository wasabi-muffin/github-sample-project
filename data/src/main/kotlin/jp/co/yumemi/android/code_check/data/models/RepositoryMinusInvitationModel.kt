 ...
 */
@Serializable
data class RepositoryMinusInvitationModel(
    ...
    val invitee: NullableMinusSimpleMinusUserModel?,
    @SerialName(value = "inviter")
    val inviter: NullableMinusSimpleMinusUserModel?,
    /* The permission associated with the invitation. */
    @SerialName(value = "permissions")
    val permissions: RepositoryMinusInvitationModel.Permissions,
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "RepositoryMinusInvitationModel.Permissions.Serializer",
