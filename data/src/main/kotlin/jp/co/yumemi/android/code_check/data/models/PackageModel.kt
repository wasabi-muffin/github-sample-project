...
import jp.co.yumemi.android.code_check.data.models.NullableMinusMinimalMinusRepositoryModel
...
data class PackageModel(
    ...
    val packageType: PackageModel.PackageType,
    ...
    val visibility: PackageModel.Visibility,
    @SerialName(value = "created_at")
    val createdAt: kotlin.String,
    @SerialName(value = "updated_at")
    val updatedAt: kotlin.String,
    @SerialName(value = "owner")
    val owner: NullableMinusSimpleMinusUserModel? = null,
    @SerialName(value = "repository")
    val repository: NullableMinusMinimalMinusRepositoryModel? = null
) {
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "PackageModel.PackageType.Serializer",
    ...
    enum class Visibility(val value: kotlin.String) {
        ...
        object Serializer {
            ...
            override val descriptor: SerialDescriptor
                get() = PrimitiveSerialDescriptor(
                    "PackageModel.Visibility.Serializer",
                    PrimitiveKind.STRING
                )
