...
import jp.co.yumemi.android.code_check.data.models.ReposOwnerRepoHooksConfigModel
 ...
 */
@Serializable
data class InlineObject91Model(
    /* Use `web` to create a webhook. Default: `web`. This parameter only accepts the value `web`. */
    @SerialName(value = "name")
    val name: kotlin.String? = null,
    @SerialName(value = "config")
    val config: ReposOwnerRepoHooksConfigModel? = null,
